<html>
	...
	<head>
		...
		<style>
			...
			#playPause{width: 24px; height:24px ;background: url("img/pause.png") no-repeat; cursor: pointer;border: none}
			#previous{width: 24px; height:24px ;background: url("img/previous.png") no-repeat; cursor: pointer;border: none}
			#next{width: 24px; height:24px ;background: url("img/next.png") no-repeat; cursor: pointer ;border: none}
			#stop{width: 24px; height:24px ;background: url("img/stop.png") no-repeat;cursor: pointer ;border: none}
