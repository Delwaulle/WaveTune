...
$(document).ready(function() {
		function lister(){
			$.ajax({
				url: "http://localhost:8080/v1/music/all/"+readCookie("pseudo"),
				type: "GET",
				dataType : "json",
	...
	function initAudio(){
		...
		var length =  document.getElementById("hide").getAttribute("value");
		playlist = new Array(length);
	...
	*/
	...
	window.addEventListener("load",lister());
});
